...
class CartViewModel(private val repository: ProductRepoImpl, application: Application) :
    ...
    var productLiveData: LiveData<List<Product>> =
        products   // live data variable which gets data back from the mutable live data to observe in CartFragment.
